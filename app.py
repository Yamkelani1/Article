...
def generate_lightweight_summary(text, num_sentences=3):
    """Generates an extractive summary using word-frequency ranking."""
...
def generate_pdf(summary, sentiment, polarity, subjectivity):
    buffer = io.BytesIO()
...
if st.button("Analyze Article"):
    if not article_text.strip():
        ...
        pdf_data = generate_pdf(summary, sentiment, polarity, subjectivity)
        st.download_button(
